export const tutorialCase = {
  ...
  concepts: {
    ...
    "Lupa": {
      type: "objeto",
      description: "Herramienta básica de detective. Revela detalles invisibles a simple vista.",
      tags: ["herramienta"]
    }
  },
  suspects: [
  ...
  interactions: [
    {
      item: "Lupa",
      choiceId: "Examinar la vitrina",
      message: "Usando la lupa, notas micro-fracturas en el borde interior. El cristal fue golpeado desde dentro con un objeto pequeño y duro.",
  ...
  scenes: {
    ...
    "exhibit-room": {
      location: "exhibit",
      art: { background: "exhibitroom" },
      text: `
          <p>La sala está acordonada. El pedestal vacío se burla de la seguridad del museo.</p>
        `,
      choices: [
        { text: "Examinar la vitrina", id: "Examinar la vitrina", next: "exhibit-case", timeCost: 15 },
        { text: "Oler el aire", id: "Oler el aire", next: "exhibit-smell", timeCost: 5 },
        { text: "Volver al vestíbulo", next: "hub", timeCost: 5 }
      ]
    },
    "exhibit-case": {
      location: "exhibit",
      art: { background: "shatteredglass" },
      text: `
    ...
    "lab-pressure": {
      ...
      art: { background: "lab" },
      text: `
          <p>Mencionas el olor a acetona en la scene. Sarah se tensa visiblemente. "Es un museo, detective. Usamos químicos. ¿Va a arrestarme por limpiar cosas?"</p>
    ...
    "basement-window": {
      location: "basement",
      art: { background: "basementwindows" },
      text: `
    ...
    "basement-floor": {
      location: "basement",
      art: { background: "muddyfootprints" },
      text: `
